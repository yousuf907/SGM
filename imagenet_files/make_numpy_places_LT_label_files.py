...
def main():
    ...
    parser.add_argument('--data', metavar='DIR', default='/data/datasets/Places_LT')  # path to Places-LT images
    parser.add_argument('--labels_dir', type=str, default='/data/datasets/Places_LT/places_LT_indices') # path to saved indices
